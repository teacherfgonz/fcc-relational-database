...
--
-- Name: elements properties_name_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--
...
--
-- Name: elements properties_symbol_key; Type: CONSTRAINT; Schema: public; Owner: freecodecamp
--

ALTER TABLE ONLY public.elements
    ADD CONSTRAINT properties_symbol_key UNIQUE (symbol);
